<x-pos-layout active="customers" title="Pelanggan" subtitle="Kelola data pelanggan dan status akun.">
    ...
    <div id="password-reset-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50">
        <div class="mx-4 w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-bold text-[#171c20]">Reset Password</h3>
            ...
            <div class="mb-4 rounded-xl bg-[#f6faff] p-4">
                <p class="mb-2 text-xs font-bold text-[#767681]">Link Reset Password:</p>
                <div class="flex gap-2">
                    <input id="reset-link-input" type="text" readonly class="flex-1 rounded-lg border border-[#c6c5d2] bg-white px-3 py-2 text-sm text-[#171c20]">
                    <button onclick="copyResetLink()" class="rounded-lg bg-[#001356] px-3 py-2 text-xs font-bold text-white transition active:scale-[0.98]">
                        Salin
                    </button>
                </div>
            </div>
            <div class="flex gap-3">
                <button onclick="sendViaWhatsApp()" class="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-4 py-3 text-sm font-bold text-white transition active:scale-[0.98]">
                ...
                <button onclick="closePasswordResetModal()" class="flex flex-1 items-center justify-center rounded-xl border border-[#c6c5d2] bg-white px-4 py-3 text-sm font-bold text-[#454650] transition active:scale-[0.98]">
                    Tutup
                </button>
            </div>
        </div>
